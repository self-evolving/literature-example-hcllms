  ...
  return (
    <h2 class={classNames(displayClass, "page-title")}>
      ...
      <a
        ...
        href="https://github.com/self-evolving/literature-example-hcllms"
        aria-label="View literature-example-hcllms on GitHub"
        title="View literature-example-hcllms on GitHub"
        target="_blank"
